...
#define EGG_BUS_DEBUG_VOC_HEATER_VOLTAGE_PLUS         65408
#define EGG_BUS_DEBUG_VOC_HEATER_VOLTAGE_MINUS        65412
#define EGG_BUS_DEBUG_VOC_HEATER_POWER_MW             65416
#define EGG_BUS_DEBUG_VOC_DIGIPOT_WIPER               65420
